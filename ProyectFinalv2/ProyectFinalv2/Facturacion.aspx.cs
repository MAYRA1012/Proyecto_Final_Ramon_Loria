    ...
    public partial class WebForm6 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dt.Rows.Add(tcodigod.Text.Trim(), tnombre.Text.Trim(), tcantidad.Text.Trim(), tprecio.Text.Trim(), ViewState["Subtotal"]);
                ViewState["Factura"] = dt;
                this.BindGrid();
        ...
        protected void Bfacturar_Click(object sender, EventArgs e)
        {
            ...
            CLsFacturacion.cliente = int.Parse(tcodigod.Text);
        ...
        protected void tcodigo_TextChanged(object sender, EventArgs e)
        {
            ...
            if (CSProductos.BuscarProducto(tcodigod.Text) > 0)
            {
                tnombre.Text = CSProductos.nombreProd;
                tprecio.Text = CSProductos.precio.ToString();
                tcantidad.Focus();
